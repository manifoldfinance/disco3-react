...
class PrivateKeyProviderConnector {
    ...
    _typedDataHash = '') {
        const result = (0, eth_sig_util_1.signTypedData_v4)(Buffer.from(this.privateKey, 'hex'), {
            data: typedData,
    ...
    decodeABIParameters(types, hex) {
        return this.web3Provider.eth.abi.decodeParameters(types, hex);
    }
}
