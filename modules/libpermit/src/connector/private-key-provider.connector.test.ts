...
describe('PrivateKeyProviderConnector', () => {
  ...
  const testPrivateKey = 'd8d1f95deb28949ea0ecc4e9a0decf89e98422c2d76ab6e5f736792a388c56c7';
  ...
  it('contractEncodeABI() changed address from null to undefined for contract instance', async () => {
    ...
    privateKeyProviderConnector.contractEncodeABI(EIP_2612_PERMIT_ABI, null, 'foo', []);
