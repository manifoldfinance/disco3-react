...
describe('Web3ProviderConnector', () => {
  ...
  it('contractEncodeABI() changed address from null to undefined for contract instance', async () => {
    ...
    web3ProviderConnector.contractEncodeABI(EIP_2612_PERMIT_ABI, null, 'foo', []);
  ...
  it('ethCall() should create a contact call', async () => {
    ...
    const result = await web3ProviderConnector.ethCall(contractAddress, callData);
  ...
  it('decodeABIParameter()', () => {
    ...
    const result = web3ProviderConnector.decodeABIParameter(type, hex);
