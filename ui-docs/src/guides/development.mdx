---
title: Development
description: Guidelines for working on @disco3/components
---
...
```bash
gh repo clone mirror-xyz/@disco3/components
yarn
yarn dev
```
...
[Create a new release](https://github.com/mirror-xyz/@disco3/componentsreleases/new) on GitHub with a tag that follows [semantic versioning](https://semver.org/). Publishing a release triggers a workflow for building, testing, and pushing to [npm](https://www.npmjs.com/package/@disco3/components).
